import os
# Vercel Hobby limits serverless function execution to 10 seconds.
# Pro plans allow extending maxDuration up to 300 seconds.
# This app makes multiple sequential Gemini calls, which typically requires 20-60 seconds.
# If deploying on Vercel Hobby, you may encounter 504 Timeout Errors. Upgrade to Pro for reliable generation.
...
def generate():
    ...
    if not api_key:
        return jsonify({"error": "Server configuration error: GEMINI_API_KEY missing from environment variables."}), 500
